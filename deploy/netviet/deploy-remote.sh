...
env \
  ...
  PROFILE_PARSER_MODE="${PROFILE_PARSER_MODE:-}" \
  PROFILE_CHANNEL_MODE="${PROFILE_CHANNEL_MODE:-}" \
  PROFILE_ADVICE_COMPOSER="${PROFILE_ADVICE_COMPOSER:-}" \
  PROFILE_AUTO_SEND="${PROFILE_AUTO_SEND:-}" \
  PROFILE_DATA_CLASSIFICATION="${PROFILE_DATA_CLASSIFICATION:-}" \
