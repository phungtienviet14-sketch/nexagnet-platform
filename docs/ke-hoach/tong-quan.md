...
- **Chất lượng (04/08/2026):** 312 test API pass + 21 skip · 27 web · 6 contract route · lint · typecheck · build đều xanh sau đợt sửa điều hướng/xác nhận `/settings`. Số liệu chi tiết bên dưới là của đợt 03/08.
