...
10. [`van-hanh/autopilot-v2-official-first.md`](van-hanh/autopilot-v2-official-first.md) — **đọc trước khi đụng vào bất cứ thứ gì tên `autopilot`**: kiểm kê toàn bộ mã tự viết, ma trận thay thế bằng tầng chính thức, kiến trúc đích và kế hoạch xoá. Quyết định: [`../kien-truc/adr-0001-autopilot-official-first.md`](../kien-truc/adr-0001-autopilot-official-first.md) — `ADOPT_GITHUB_NATIVE_GH_AW`. Mục dưới đây là **bản bị thay thế**, giữ lại để đọc lịch sử.
11. [`van-hanh/autopilot-protocol-v0.md`](van-hanh/autopilot-protocol-v0.md) — ⚠️ **SUPERSEDED bởi ADR-0001**: giao thức ChatGPT ↔ GitHub ↔ Claude V0 — tác nhân, 9 thông điệp có marker, máy trạng thái 8 trạng thái, quy tắc SHA/CI/rủi ro/retry/idempotency, Task Contract, validator CLI. **Nền tảng giao thức** — chưa có orchestrator hay dispatcher.
