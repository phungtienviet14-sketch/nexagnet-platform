...
> **Nguồn kế hoạch:** [GĐ1 Ultty §4 CHẶN E + §6 Đợt A′](../../ke-hoach/gd1-ultty.md) · đặc tả task ở [tổng quan §1](../../ke-hoach/tong-quan.md).
...
**Task 1 KHÔNG bao gồm** (vẫn thuộc Đợt A′, các task sau — xem [GĐ1 Ultty §4](../../ke-hoach/gd1-ultty.md)):
