 ...
 *
 * ============================================================================================
 * TEP NAY NAM O `config/` TU `#287`, va do la mot lan DOI CHO chu khong mot lan viet moi
 * ============================================================================================
 *
 * Chinh tep nay da viet: *"CO CHE la thu dung chung; DANH SACH INDEX thi thuoc ve capability so
 * huu bang do"*. Chung nao co che con nam trong `transport/`, cau do chi dung mot nua — mot mien
 * ngoai van tai muon dung no phai `import` xuyen vao mot mien ma phan lon khach khong bat.
 *
 * `#287` la mien dau tien o `foundation` can den no, nen co che chuyen ve day va
 * `transport/storage-conflict.ts` XUAT LAI nguyen ven: hai muoi cho dang `import` khong phai doi
 * mot dong, va hai hang so index cua van tai o lai dung cho cu cua chung.
 *
