...
export function useAccountLinks(userId: string | null, enabled: boolean) {
  return useQuery({
...
export function useDriverCandidates(enabled: boolean) {
  return useQuery({
...
export function useStakeholderCandidates(enabled: boolean) {
  return useQuery({
...
export function useAdminPlaces(enabled: boolean) {
  return useQuery({
...
export function usePlaceHistory(placeId: string | null, isOpen: boolean) {
  return useQuery({
    queryKey: ADMIN_QUERY_KEYS.placeHistory(placeId ?? 'none'),
    queryFn: () => placesAdminApi.history(placeId as string),
    enabled: isOpen && placeId !== null,
    staleTime: 0,
  });
}

export function useOwnerCustomers(enabled: boolean) {
  return useQuery({
...
export function useOwnerCounterparties(enabled: boolean) {
  return useQuery({
