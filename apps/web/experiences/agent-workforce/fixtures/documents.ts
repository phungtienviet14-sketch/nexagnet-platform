...
export const SAMPLE_DOCUMENTS: readonly DocumentItem[] = [
  {
    ...
    analysis: {
      metadata: {
        'Số hợp đồng': 'HĐ-2026-VF09/NETVIET-VF',
        'Bên bán (Bên A)': 'Công ty Cổ phần Truyền thông & Công nghệ NetViet',
      ...
      complianceFindings: [
        ...
        },
        {
          ...
          result: 'pass',
          detail: 'Quyền tác giả và tài sản trí tuệ đối với phần mềm/thuật toán được xác lập rõ ràng thuộc NetViet.',
        },
      ],
  ...
  },
  {
    ...
    analysis: {
      metadata: {
        ...
        'Số hóa đơn': '0002891',
        'Ngày lập': '15/07/2026',
        'Đơn vị bán': 'Công ty Cổ phần Truyền thông & Công nghệ NetViet (MST: 0108998877)',
  ...
  },
  {
    ...
    analysis: {
      metadata: {
        ...
        'Cơ quan ban hành': 'Khối Vận hành & Công nghệ NetViet',
