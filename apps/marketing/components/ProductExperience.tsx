...
const WORKFLOW_PRESETS: Record<ModuleType, WorkflowData> = {
  orders: {
    ...
    rulesItems: [
      { label: 'Biểu giá sản phẩm', status: 'Đã xác thực', detail: 'Đơn giá & SKU khớp danh mục chuẩn' },
      { label: 'Chính sách thương mại', status: 'Đã xác thực', detail: 'Áp đúng điều khoản theo cấp đối tác' },
      { label: 'Hạn mức công nợ', status: 'Đạt yêu cầu', detail: 'Hạn mức nợ 30 ngày hợp lệ' },
      { label: 'Ngưỡng tự động hóa', status: 'Đạt yêu cầu', detail: 'Tổng SL ≤ 50 (Đạt ngưỡng tự động)' },
    ],
    validateText: 'ĐÃ XÁC THỰC · ĐẠT 4/4 QUY TẮC',
    autoTitle: 'Tự động thực thi',
    autoDetail: 'Tự động soạn đơn & gửi tin xác nhận Zalo',
    autoTarget: 'Ghi nhận vào hàng việc Sales nhận việc',
