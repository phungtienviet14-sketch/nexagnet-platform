...
1. [docs/nghiep-vu.md](docs/nghiep-vu.md) — 1️⃣ **NGHIỆP VỤ đối chiếu NGUỒN GỐC** (quy trình đặt hàng thật 9 bước + **2 cổng KSNB**, 4 chính sách + điều khoản PO thật, 7 intent, đội 6 agent) kèm **bảng SAI LỆCH nguồn-gốc ↔ code** (VAT-default, phí COD, cước ship đang *tạm tính*) — **đọc trước khi sửa rules engine**. Đã đối chiếu code 11/07/2026 (code là chuẩn as-built)
