...
maestro_env=(
  ...
  -e "MAESTRO_INTAKE_DRIVER_USERNAME=${MAESTRO_INTAKE_DRIVER_USERNAME}"
  -e "MAESTRO_INTAKE_DRIVER_NAME=${MAESTRO_INTAKE_DRIVER_NAME}"
  -e "MAESTRO_REVIEW_DRIVER_USERNAME=${MAESTRO_REVIEW_DRIVER_USERNAME}"
  -e "MAESTRO_INTAKE_DESTINATION_PLACE_ID=${MAESTRO_INTAKE_DESTINATION_PLACE_ID}"
